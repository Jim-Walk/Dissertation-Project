...
\subsection{OpenMP}
The first specification for the OpenMP C and C++ application program interface (API) was released in October 1998. Its aim was to "allow users to create and manage parallel programs while permitting portability"\cite{OpenMPSpec}.
\begin{itemize}
