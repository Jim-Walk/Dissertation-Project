...
\captionof{listing}{Babel Stream C parallel initialisation}
\end{code}
\end{minipage}\hfill
\begin{minipage}{.48\textwidth}
\begin{code}
...
\end{minted}
\label{lst:parInit}
\captionof{listing}{Babel Stream Rust parallel initialisation}
\end{code}
\end{minipage}
...
I used version 6.3.0 of GNU project C  and C++ compiler, \texttt{gcc} \texttt{g++} to compile and run the reference implementations of the kernels. Version 1.34.2 of the Rust compiler, \texttt{rustc} was used.\todo{do I need to justify this choice}
