...
\todo{explain why babel stream gives good insight to memory}
...
this implementation also uses netcdf which is also v common so interesting to see how hard it is to get Rust to work with it.
